...
This module provides endpoints to retrieve game information with associated publisher and category data.
"""
...
def get_games_base_query() -> Query:
    """
    Create base query for games with joined publisher and category data.
...
def get_game(id: int) -> tuple[Response, int] | Response:
    ...
    Returns:
        Response: JSON response containing game data or error message
