<!--
GameList Svelte component for the Tailspin Toys Crowd Funding platform.
This component displays a grid of games with loading states, error handling, and responsive design.
-->
<script lang="ts">
